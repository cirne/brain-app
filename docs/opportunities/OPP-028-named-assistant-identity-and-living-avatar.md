...
| **Cross‑user language** ([Brain-to-brain collaboration](../ideas/IDEA-wiki-sharing-collaborators.md)) | "your brain talks to my brain"                                  | "Corvin will reach out to Kalem on your behalf"—agent‑to‑agent gains social texture because each instance has a name                                                                                                                                                                                                                                                                                     |
...
| [Brain-to-brain collaboration](../ideas/IDEA-wiki-sharing-collaborators.md) | Cross‑user agent communication gains social texture. "Corvin reached out to Kalem about scheduling" reads as a relationship, not a protocol. The naming layer is what makes the federated story human. |
| Public brain identity (deferred — see [Brain-to-brain collaboration](../ideas/IDEA-wiki-sharing-collaborators.md)) | Public‑facing identity benefits enormously from named, faced agents. "You're talking to Lewis Cirne's assistant Corvin" beats "you're talking to Lewis Cirne's brain." |
...
- Cross‑user avatar visibility or sharing. (Could become interesting under [Brain-to-brain collaboration](../ideas/IDEA-wiki-sharing-collaborators.md), but not in scope here.)
