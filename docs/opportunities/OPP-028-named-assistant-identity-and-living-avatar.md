...
The user picks. An **illustrated avatar** is generated in their chosen visual style. From that moment on, **the product speaks in that name**: top nav, chat avatar, notifications, system messages, marketing surfaces. There is no "Brain" anywhere the user can see. There is **Corvin**, or **Kalem**, or **Dirac**.
...
| Surface                                                                                                         | Today                                                           | After                                                                                                                                                                                                                                                                                                                                                                                                    |
| --------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Product name (visible)**                                                                                      | "Brain"                                                         | The user's chosen assistant name. "Brain" survives only as an internal codename / repo / process name.                                                                                                                                                                                                                                                                                                   |
...
| **Cross‑user language** ([OPP-001](./OPP-001-agent-to-agent.md), [OPP-002](./OPP-002-public-brain-identity.md)) | "your brain talks to my brain"                                  | "Corvin will reach out to Kalem on your behalf"—agent‑to‑agent gains social texture because each instance has a name                                                                                                                                                                                                                                                                                     |
| **Marketing / public**                                                                                          | "Brain is your local assistant"                                 | "Brain gives you **your** assistant—Corvin, Kalem, whoever they turn out to be." Brand‑level promise becomes *the assistant is yours*, not a product.                                                                                                                                                                                                                                                    |
...
| [OPP-001: Agent‑to‑Agent](./OPP-001-agent-to-agent.md)                                     | Cross‑user agent communication gains social texture. "Corvin reached out to Kalem about scheduling" reads as a relationship, not a protocol. The naming layer is what makes the federated story human. |
...
- Cross‑user avatar visibility or sharing. (Could become interesting under [OPP-001](./OPP-001-agent-to-agent.md) / [OPP-002](./OPP-002-public-brain-identity.md), but not in scope here.)
