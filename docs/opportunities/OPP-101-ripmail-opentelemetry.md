...
**Related today:** [`ripmail/src/observability/nr_diagnostic_logs.rs`](../../ripmail/src/observability/nr_diagnostic_logs.rs) (best-effort NR logs), sync log files under `RIPMAIL_HOME/logs/`, brain-app **[OPP-071](OPP-071-llm-telemetry-traces-and-usage-cli.md)** / [docs/newrelic.md](../newrelic.md) (Node-side custom events and APM).
...
4. **[OPP-071](OPP-071-llm-telemetry-traces-and-usage-cli.md)** explicitly defers “replacing the whole stack with OpenTelemetry export” for **Node**; ripmail is a natural place to **pilot OTLP** without rewriting the web tier.
...
- [ripmail/AGENTS.md](../../ripmail/AGENTS.md) — Rust workflow and testing expectations.
