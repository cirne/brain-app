...
- [OPP-089](archive/OPP-089-google-design-md-exploratory.md) — **DESIGN.md** spike **shipped** (agent-facing spec + `design:lint`); fuller tooling optional, **depends on** this epic’s token baseline.
