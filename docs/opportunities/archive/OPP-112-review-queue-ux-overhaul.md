...
**Status:** Archived (2026-05-13) — narrative retained for reference.  
...
**OPP-112 archived (2026-05-13).** Pass **1** is complete on this id. **Issue 7** and **Issue 8** are **not** active under OPP-112—open a **new opportunity** if you prioritize them (code may still cite **OPP-112** for partial cold-query handshake fields).

### Historical follow-up ideas (Issues 7–8)
