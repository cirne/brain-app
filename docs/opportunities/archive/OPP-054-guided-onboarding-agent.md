# Archived: OPP-054 — Guided onboarding

**Status: Archived (2026-05-11).** Onboarding shipped in code; product intent archived. **Implementation:** [onboarding-state-machine.md](../../architecture/onboarding-state-machine.md).

**Stub:** [../OPP-054-guided-onboarding-agent.md](../OPP-054-guided-onboarding-agent.md)
...
**Related:** **[Onboarding implementation (states, mail gates)](../../architecture/onboarding-state-machine.md)** · [OPP-093 (archived)](archive/OPP-093-phased-onboarding-sync.md) (phased first sync — superseded by **[archived OPP-094](archive/OPP-094-holistic-onboarding-background-task-orchestration.md)** · [stub](OPP-094-holistic-onboarding-background-task-orchestration.md)) · [OPP-006 (archived)](archive/OPP-006-email-bootstrap-onboarding.md), [OPP-018 (archived)](archive/OPP-018-first-chat-post-onboarding.md), [OPP-028](OPP-028-named-assistant-identity-and-living-avatar.md), [OPP-060](OPP-060-starter-wiki-templates-and-agent-authoring.md) (starter wiki templates — align `me.md` / vault init timing), **[archived OPP-068](archive/OPP-068-wiki-template-user-profiles.md)** · [stub](OPP-068-wiki-template-user-profiles.md) (persona wiki presets — rank **all** candidates on mail traffic, surface **top 3**), [OPP-084](OPP-084-adaptive-rules-learning-agent.md) *(ex–ripmail OPP-047)*
