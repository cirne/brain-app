# Archived: OPP-080 — Ripmail home permissions
...
### OPP-080: Ripmail home permissions — secure defaults and data lifecycle

**Former ripmail id:** OPP-028 (unified backlog 2026-05-01).
...
- Keep **first-class** support for “delete everything and start over” and “drop large cached trees” (aligned with [AGENTS.md](../../ripmail/AGENTS.md) no-migrations / reset-from-disk philosophy).
...
- [AGENTS.md](../../ripmail/AGENTS.md) — data location, no migrations, reset patterns.
