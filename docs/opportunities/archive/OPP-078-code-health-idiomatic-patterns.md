# Archived: OPP-078 — Code health (ripmail)

**Status: Archived (2026-05-11).** Ripmail corpus backlog closed for tracking.

**Stub:** [../OPP-078-code-health-idiomatic-patterns.md](../OPP-078-code-health-idiomatic-patterns.md)

---

## Original spec (historical)

### OPP-078: Code Health Sprint — Simplify, Reuse, and Idiomatic Patterns

**Former ripmail id:** OPP-017 (unified backlog 2026-05-01).
