# Archived: OPP-049 — Global UI refactor — Tailwind-first stylesheet
...
**Status:** Complete for backlog tracking; see archive banner above. Ongoing hygiene: [tailwind-migration](../../architecture/tailwind-migration.md).

The strangler `tw-components/` tree is folded into the sole [`src/client/components/`](../../../src/client/components/); imports use `@components/…`. Further work is normal product hygiene.
