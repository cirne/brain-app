...
- [OPP-050 (archived, shipped)](./OPP-050-press-to-talk-dev-only-feature-flag.md) — original dev-only gate for press-to-talk + `/api/transcribe` (later relaxed in code; see banner above).
