...
- **Folders:** add/remove, validation, re-index triggers; complements onboarding folder suggestions **[OPP-014](./OPP-014-onboarding-local-folder-suggestions.md)** and the unified sources direction in **[archived OPP-087](archive/OPP-087-unified-sources-mail-local-files-future-connectors.md)** · **stub [OPP-087](OPP-087-unified-sources-mail-local-files-future-connectors.md)**.
