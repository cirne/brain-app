...
**Related:** [OPP-008 stub](./OPP-008-tunnel-qr-phone-access.md) (full product spec: [archive](archive/OPP-008-tunnel-qr-phone-access.md)), [Brain-to-brain collaboration](../ideas/archive/IDEA-wiki-sharing-collaborators.md) (inter-brain endpoints and handle resolution build on stable remote URLs).
