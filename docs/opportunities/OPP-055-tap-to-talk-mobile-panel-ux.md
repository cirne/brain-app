...
**Replaces:** hold-to-speak in [archived OPP-050](archive/OPP-050-press-to-talk-dev-only-feature-flag.md)  
**Continues:** [OPP-046](OPP-046-voice-input-press-to-talk-wispr-flow.md) (vendor/STT research still applies)
...
- [OPP-050 (archived)](archive/OPP-050-press-to-talk-dev-only-feature-flag.md) — shipped dev gate; component file references for the existing implementation.
- [OPP-008](OPP-008-tunnel-qr-phone-access.md) — phone as primary client; same surface this UX targets.
