...
Holistic view for **mail indexing**, **onboarding milestones**, **wiki first-draft bootstrap** ([OPP-095 (archived)](../opportunities/archive/OPP-095-wiki-first-draft-bootstrap.md)), and **Your Wiki** supervisor — ships the framing in [OPP-094 (archived)](../opportunities/archive/OPP-094-holistic-onboarding-background-task-orchestration.md).
