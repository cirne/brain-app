...
**Related opportunities:** **[OPP-042](../opportunities/OPP-042-brain-network-interbrain-trust-epic.md)** (canonical brain-network epic), [OPP-001](../opportunities/OPP-001-agent-to-agent.md) (agent-to-agent protocol), [OPP-002](../opportunities/OPP-002-public-brain-identity.md) (public brain identity), [OPP-008](../opportunities/OPP-008-tunnel-qr-phone-access.md) (tunnels), [OPP-030](../opportunities/archive/OPP-030-agent-driven-support-bug-to-pr.md) (support/bug pipeline).
...
- **Discovery and connection.** Two brains that want to communicate need a rendezvous point. The registry provides a stable, publicly reachable endpoint for each registered brain (and can back **Braintunnel-style handles**), without revealing who owns it. This is the infrastructure layer beneath [OPP-042](../opportunities/OPP-042-brain-network-interbrain-trust-epic.md), [OPP-001](../opportunities/OPP-001-agent-to-agent.md)'s bilateral trust channels, and [OPP-002](../opportunities/OPP-002-public-brain-identity.md)'s public identity.
...
- **Contact via your assistant.** Eventually, the way to get in touch with you is to reach your brain. The registry is how strangers find it. This is the top of the funnel described in OPP-002's tiered access model: the registry gives your brain a stable internet address; OPP-002 describes what happens when someone shows up there.
...
For features like [OPP-008](../opportunities/OPP-008-tunnel-qr-phone-access.md) (phone access via QR / tunnel) and the brain-to-brain direct channels in [OPP-001](../opportunities/OPP-001-agent-to-agent.md) / [OPP-042](../opportunities/OPP-042-brain-network-interbrain-trust-epic.md), there may be infrastructure we need to run centrally for NAT traversal and tunnel setup — especially when both brains are behind NAT and can't reach each other directly.
...
- **Brain-to-brain relay (ephemeral).** During the [OPP-001](../opportunities/OPP-001-agent-to-agent.md) handshake (see epic [OPP-042](../opportunities/OPP-042-brain-network-interbrain-trust-epic.md)), before two brains have established a direct channel, a central relay might broker the initial exchange. After the channel is set up, the relay is no longer involved.
- **Public directory (opt-in).** An indexed, searchable listing of brains that have chosen to be discoverable — tagged by interests, expertise, availability. Referenced in OPP-002. No private data; only what each brain explicitly publishes.
