...
| [onboarding-state-machine.md](./onboarding-state-machine.md) | **First-run:** persisted `onboarding.json` states, transitions, phased mail backfill (30d then 1y), `GET /mail` poll vs ripmail lanes — [OPP-093](../opportunities/OPP-093-phased-onboarding-sync.md), [OPP-054](../opportunities/OPP-054-guided-onboarding-agent.md) |
