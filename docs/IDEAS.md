...
| [IDEA-wiki-sharing-collaborators](ideas/IDEA-wiki-sharing-collaborators.md) | Wiki sharing with collaborators (dirs, RW/RO) | Share vault subtrees (e.g. `trips/`) with another user — assistant travel collaboration — read-only or read-write; individuals before groups. **[OPP-064](opportunities/OPP-064-wiki-directory-sharing-read-only-collaborators.md)** Phase 1 (stub) / **[archive](opportunities/archive/OPP-064-wiki-directory-sharing-read-only-collaborators.md)**; layout/tools **[OPP-091](opportunities/OPP-091-wiki-unified-namespace-sharing-projection.md)**. Write access, tighter agent-scope without projection mapping, handle-based identity, and conflict resolution remain open in the idea file. |
| [IDEA-brain-query-delegation](ideas/IDEA-brain-query-delegation.md) | Brain-query delegation (B2B fast path) | **Phase 0 shipped (hosted):** `ask_brain`, per-connection **policy + grants**, research + privacy-filter passes, audit log. **Hub / Brain access admin (Spike 1) closed (2026-05)** — [architecture § Hub closure](architecture/brain-to-brain-access-policy.md#hub-brain-access-admin-shipped--opp-099-closure); epic **[OPP-099 stub](opportunities/OPP-099-brain-to-brain-admin-hub-ui.md)**. **Target policy shape:** [architecture/brain-to-brain-access-policy.md](architecture/brain-to-brain-access-policy.md) (draft). Open product question: whether **wiki directory sharing** remains worth its complexity vs doubling down on secure brain-to-brain query (see idea doc). |
