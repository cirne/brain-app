...
| File                                                                                        | Title                              | Summary                                                                                                                                                                                                                                                                            |
| ------------------------------------------------------------------------------------------- | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [IDEA-slack-personal-ambassador](ideas/IDEA-slack-personal-ambassador.md) | Slack personal ambassador | Per-user AI ambassador in team Slack: answers questions on your behalf from your wiki + email corpus, presence-aware toggle, per-contact policies, approve/edit/decline draft replies **straight from Slack** (Block Kit), attribution footer as acquisition flywheel. Architecturally a new intake channel for the B2B tunnel draft→review→send model. |
