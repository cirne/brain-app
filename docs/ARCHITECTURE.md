...
| **Multi-tenant cloud architecture (S3 + local, locks)**          | [architecture/multi-tenant-cloud-architecture.md](architecture/multi-tenant-cloud-architecture.md) · B2B tunnel **cross-cell** follow-on → [chat-history-sqlite.md § B2B](architecture/chat-history-sqlite.md#b2b-cross-tenant-writes-and-cell-scaling) |
