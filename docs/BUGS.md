...
| BUG-021 | Calendar: events shown or imported in UTC instead of user timezone | **Open.** User-facing **wall-clock** errors: calendar data interpreted or displayed in **UTC** instead of the user’s **IANA** timezone (e.g. Eastern). See [bugs/BUG-021-calendar-events-utc-instead-of-user-timezone.md](bugs/BUG-021-calendar-events-utc-instead-of-user-timezone.md). User feedback #6. |
