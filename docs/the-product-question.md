...
**Related:** [VISION.md](./VISION.md) · [STRATEGY.md](./STRATEGY.md) · [the-wiki-question.md](./the-wiki-question.md) · [karpathy-llm-wiki-post.md](./karpathy-llm-wiki-post.md) · [product/personal-wiki.md](./product/personal-wiki.md) · [architecture/integrations.md](./architecture/integrations.md) · [architecture/per-tenant-storage-defense.md](./architecture/per-tenant-storage-defense.md) · [architecture/wiki-read-vs-read-email.md](./architecture/wiki-read-vs-read-email.md) · [ideas/archive/IDEA-wiki-sharing-collaborators.md](./ideas/archive/IDEA-wiki-sharing-collaborators.md)

---

## Why this document exists

[VISION.md](./VISION.md) and [STRATEGY.md](./STRATEGY.md) commit Braintunnel to two big bets: (1) **personalization compounds** because the LLM owns a maintained wiki, and (2) **email is the richest personal data source** so [indexed mail](../src/server/ripmail/index.ts) gives the agent ground truth. Today's product is a coherent expression of those bets — but the *category label* under which we go to market is still open.
...
4. **Brain-to-brain network as a future-shaped moat.** Bilateral, scoped trust edges between personal brains — read-only Phase 1 already shipped ([archived OPP-064](./opportunities/archive/OPP-064-wiki-directory-sharing-read-only-collaborators.md), [OPP-091 archived spec](./opportunities/archive/OPP-091-wiki-unified-namespace-sharing-projection.md), [architecture/wiki-sharing.md](./architecture/wiki-sharing.md)). Sequencing in [IDEA-wiki-sharing-collaborators.md](./ideas/archive/IDEA-wiki-sharing-collaborators.md).
5. **Agent surface that already covers EA-style work**: read/write Gmail, full Google Calendar CRUD ([archived OPP-070](./opportunities/archive/OPP-070-full-calendar-read-write-agent-surface.md)), drafts with on-disk markdown editing ([archived OPP-056](./opportunities/archive/OPP-056-email-draft-overlay-markdown-editor.md)), web search/fetch, YouTube transcripts, optional macOS iMessage. Inventory: [`agentToolSets.ts`](../src/server/agent/agentToolSets.ts).
...
- **EA framing leaves brain-to-brain stranded.** The whole network-effect moat ([STRATEGY.md](./STRATEGY.md), [IDEA-wiki-sharing-collaborators.md](./ideas/archive/IDEA-wiki-sharing-collaborators.md)) makes no sense in an EA frame, because EAs do not coordinate with each other across organizational boundaries.
