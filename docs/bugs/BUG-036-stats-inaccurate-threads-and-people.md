# BUG-036: `ripmail stats` reports misleading thread and people counts

**Former ripmail id:** BUG-038 (unified backlog 2026-05-01).

**Status:** Open. **Created:** 2026-04-05. **Tags:** stats, cli, data-model, agent-first

**Design lens:** [Agent-first](../../ripmail/docs/VISION.md) — `ripmail stats` is a quick health snapshot for users and agents. If numbers look obviously wrong (threads equal to every message, people always zero), trust in the whole CLI degrades and agents may mis-plan work (e.g. "no contacts indexed").
