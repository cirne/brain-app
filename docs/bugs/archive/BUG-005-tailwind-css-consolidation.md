...
**Status:** Archived — **superseded by [archived OPP-049](../../opportunities/archive/OPP-049-global-ui-tailwind-refactor.md)** (**shipped**).
...
**Resolution:** The scope is **rolled into OPP-049** (global Tailwind-first UI refactor), **shipped (2026-05-02)** — see [archived OPP-049](../../opportunities/archive/OPP-049-global-ui-tailwind-refactor.md). **Ongoing hygiene** (tokens, scoped CSS pruning): [tailwind-migration.md](../../architecture/tailwind-migration.md). **Do not** revive this bug as an active duplicate.
