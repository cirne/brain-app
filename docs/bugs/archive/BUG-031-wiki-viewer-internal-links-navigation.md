...
**Status:** **Archived (2026-05-15).** Wiki viewer internal link navigation fixed.

**Was:** **Open.** Reporter indicates the issue is **not** resolved after multiple client-side fixes. This document records symptoms, architecture, everything attempted, assumptions that may be wrong, and a simpler long-term direction.
