...
A **fast, scannable** daily snapshot in chat—not a research paper. **Density over breadth**; deeper work: **briefing** (one meeting) or **research** (durable wiki).

## Preconditions

- Use: **calendar**, **inbox/ripmail** (light), **wiki** (search/read) as needed.
- If a capability is missing, **one** line and continue.
