...
export const chatHistoryRailPrimaryBtn =
  'mb-2 box-border flex w-full max-w-full cursor-pointer items-center justify-start gap-1.5 rounded-md border border-border bg-surface-3 px-2.5 py-[7px] text-left text-xs font-medium text-foreground transition-colors hover:bg-surface hover:border-muted max-md:text-[13px]'
