...
export const chatHistoryRailPrimaryBtn =
  'mb-2 box-border flex w-full max-w-full cursor-pointer items-center justify-start gap-1.5 border border-border bg-surface-3 px-2.5 py-[7px] text-left text-xs font-medium text-foreground transition-colors hover:bg-surface hover:border-muted max-md:text-[13px]'

export const chatHistoryRailViewAllBtn =
  'mt-1.5 box-border flex w-full max-w-full cursor-pointer border border-dashed border-border bg-transparent px-2 py-1.5 text-left text-[11px] font-medium text-accent transition-colors hover:bg-surface-3 hover:border-muted focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent focus-visible:outline-offset-1 max-md:text-xs'
