...
{:else}
  <div
    class="chat-message-row group relative mb-5 box-border flex w-full max-w-[min(800px,100%)] gap-2"
    data-testid="chat-message-row"
  >
    <div
      class={[
    ...
    >
      ...
      {:else}
        <div class="msg-label mb-1 flex items-start justify-between gap-2 text-[11px] font-semibold tracking-[0.05em] text-muted uppercase">
