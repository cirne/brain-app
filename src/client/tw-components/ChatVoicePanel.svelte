<script lang="ts">
  ...
  import VoiceActionButtons from '@tw-components/VoiceActionButtons.svelte'
  import VoicePrimaryButton from '@tw-components/VoicePrimaryButton.svelte'
  import RecordingWaveformIndicator from '@tw-components/RecordingWaveformIndicator.svelte'
