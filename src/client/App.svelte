<script lang="ts">
  ...
  import Assistant from '@tw-components/Assistant.svelte'
  import FullDiskAccessGate from '@tw-components/onboarding/FullDiskAccessGate.svelte'
  import Onboarding from '@tw-components/onboarding/Onboarding.svelte'
  import HostedSignIn from '@tw-components/onboarding/HostedSignIn.svelte'
  import EnronDemoLogin from '@tw-components/onboarding/EnronDemoLogin.svelte'
