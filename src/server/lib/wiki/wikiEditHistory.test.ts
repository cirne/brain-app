...
describe('wikiEditHistory', () => {
  ...
  it('readRecentWikiEdits returns empty when file missing', async () => {
    const { readRecentWikiEdits } = await import('@server/lib/wiki/wikiEditHistory.js')
  ...
  it('normalizeWikiRelativePath produces forward slashes relative to wiki root', async () => {
    const { normalizeWikiRelativePath } = await import('@server/lib/wiki/wikiEditHistory.js')
  ...
  it('resolveSafeWikiPath throws on escape or wiki root', async () => {
    const { resolveSafeWikiPath } = await import('@server/lib/wiki/wikiEditHistory.js')
