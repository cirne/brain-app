...
import { brainHome, ripmailHomeForBrain, wikiContentDir } from './brainHome.js'
import { dataRoot, isMultiTenantMode } from './dataRoot.js'
...
/** True if `absolutePath` may be read via `read_doc` / `/api/files/read` for this tenant. */
