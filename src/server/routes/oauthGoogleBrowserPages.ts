...
<head>
  ...
  <meta http-equiv="refresh" content="3;url=/onboarding/not-started" />
  ...
  <script>
    ...
    setTimeout(function () { window.location.replace('/onboarding/not-started'); }, 600);
  </script>
</head>
<body>
  <h1>Gmail connected</h1>
  <p>Redirecting… If nothing happens, <a href="/onboarding/not-started">continue here</a>.</p>
...
<body>
  ...
  <p>${safe}</p>
  <p><a href="/onboarding/not-started">Back to setup</a> to try Connect Google again.</p>
