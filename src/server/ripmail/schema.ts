/**
 * SQLite schema — SCHEMA_VERSION 32 (historically aligned with the Rust ripmail crate; see git tag
 ...
 * Split into individual statements so we can execute each in sequence.
 */
