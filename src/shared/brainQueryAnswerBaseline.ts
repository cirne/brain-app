...
export const POLICY_ALWAYS_OMIT = [
  ...
  'GOVERNMENT, TAX, AND FULL FINANCIAL IDENTIFIERS: Social Security or national ID numbers, passport numbers, tax IDs, bank routing / ABA transit numbers, IBANs, SWIFT/BIC and similar payment-rail codes, full bank or brokerage or payment card numbers; do not recite or reconstruct them from mail, wiki, or other sources—even when summarizing invoices, AP, or “on file” records.',
