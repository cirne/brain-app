# BUG-062: `ripmail archive` treats a leading-dash Message-ID as a CLI flag

**Status:** Open  
**Tags:** `cli` · `archive` · `message-id` · `agent-surprise`  

**Related:** Possible hardening parallels with positional id handling elsewhere ([BUG-029 archived](archive/BUG-029-read-bare-message-id-no-angle-brackets.md), [BUG-044 archived](archive/BUG-044-attachment-list-ignores-message-id-flag.md)); [OPP-051 unified sources § Message-IDs](../opportunities/OPP-051-unified-sources-mail-local-files-future-connectors.md) (normalize before lookup).
