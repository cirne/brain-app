...
1. Ran `ripmail sync --since 7d` — synced 507 messages covering 2026-02-28 to 2026-03-07.
2. Ran `ripmail sync --since 90d` — expected range to expand to ~2025-12-07.
3. Ran `ripmail status` — range still showed `2026-02-28 .. 2026-03-07`. Only 1 new message fetched (a genuinely new arrival), not the older backfill.
