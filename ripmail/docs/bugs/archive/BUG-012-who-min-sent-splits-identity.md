...
- **Status:** Verified
- **Date:** 2026-03-07
- **Result:** Fix confirmed. `ripmail who "matt" --min-sent 3` now returns Matt Shandera with both addresses merged (matt@gamaliel.ai + mshandera@gamaliel.ai, sentCount: 4). The filter now applies after identity merging, not before.
- **Tested with:** `ripmail who "matt" --min-sent 3`, `ripmail who "matt shandera"`
