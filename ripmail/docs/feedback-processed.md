...
| `ux-actionable-error-messages.md` | 2026-03-31 | Created bug | [BUG-035](../../../docs/bugs/BUG-035-actionable-file-not-found-errors.md) — missing local files still surface raw OS/path errors instead of actionable ripmail-specific recovery messages |
