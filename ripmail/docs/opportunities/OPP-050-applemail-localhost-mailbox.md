# OPP-050: Apple Mail Localhost Mailbox — Local Index Without IMAP
...
- [OPP-045](OPP-045-imessage-and-unified-messaging-index.md) — iMessage + unified messaging; same FDA story, different data source.
- [OPP-016 archived](archive/OPP-016-multi-inbox.md) — multi-mailbox architecture this would extend.
- [OPP-009 archived](archive/OPP-009-agent-friendly-setup.md) — wizard UX patterns.
