...
- **Send / drafts (archived):** [OPP-011 archived](archive/OPP-011-send-email.md), [ADR-024](../../docs/ARCHITECTURE.md#adr-024-outbound-email--smtp-send-as-user--local-drafts) in `ARCHITECTURE.md`.
