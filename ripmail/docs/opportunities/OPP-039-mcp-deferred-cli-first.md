# OPP-039: MCP (stdio) — Deferred; Reintroduction Gated on CLI and Benefit

**Status:** Open (intentional deferral). **Created:** 2026-04-05. **Merged (2026-04-10):** Former **OPP-040** (gating and benefit bar for in-tree MCP) absorbed into this document; the standalone OPP-040 file was removed — recover from git history if needed.
...
Track answer-pipeline transport separately in [OPP-020](archive/OPP-020-answer-engine-local-agent.md).
...
- [ADR-005](../ARCHITECTURE.md#adr-005-agent-interface--native-cli-primary) — agent interface decision
- [BUG-025 archived](../bugs/archive/BUG-025-mcp-cli-parity-deferred.md) — prior parity bug superseded by this deferral
- [OPP-020](archive/OPP-020-answer-engine-local-agent.md) — `ripmail ask` and optional transports
