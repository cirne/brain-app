...
/// Gmail IMAP/SMTP + Google Calendar read + Google Drive read.
pub const GOOGLE_OAUTH_SCOPE_MAIL_CALENDAR_READONLY: &str =
    "https://mail.google.com/ https://www.googleapis.com/auth/calendar.readonly https://www.googleapis.com/auth/drive.readonly";
/// Wizard path: mail + calendar + Drive read + OpenID email discovery.
