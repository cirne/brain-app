...
//! see `tests/suite/aaa_use_nextest.rs`.
...
pub use db::{
    ...
    open_file_readonly, open_memory, open_shared, purge_mailbox_from_index, DbError, SharedConn,
    SCHEMA_VERSION,
};
pub use ids::{
...
pub use sync::{
    acquire_lock, append_ripmail_process_diag_line, connect_imap_for_resolved_mailbox,
    connect_imap_session, connect_imap_session_with_auth, filter_uids_after, forward_uid_range,
    is_process_alive, is_sync_lock_held, millis_since_sync_lock_started_at,
    ...
    resolve_sync_mailbox, resolve_sync_since_ymd, ripmail_process_diag_log_path,
